<template>
  <div class="container">
      ...
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="日期">
          <el-date-picker
            ...
            @visible-change="
              (visibility) =>
                handleVisibleChange(visibility, 'shiditurang', 'month')
            "
            :disabled-date="
              (time) => disabledDate(time, 'shiditurang', 'month')
            "
          >
          </el-date-picker>
          <el-date-picker
            ...
            @visible-change="
              (visibility) =>
                handleVisibleChange(visibility, 'shiditurang', 'year')
            "
            :disabled-date="(time) => disabledDate(time, 'shiditurang', 'year')"
          >
          </el-date-picker>
    ...
    >
      ...
      ></el-table-column>
      <el-table-column
        prop="soil_moisture_content"
        label="土壤含水量(g/100g)"
        width="auto"
        align="center"
      ></el-table-column>
      <el-table-column
        prop="soil_organic_matter_content"
        label="土壤有机质含量(g/100g)"
        width="auto"
        align="center"
      ></el-table-column>
      <el-table-column
        prop="total_soil_carbon_content"
        label="土壤含碳总量(g/100g)"
        width="auto"
        align="center"
      ></el-table-column>
      <el-table-column
        prop="total_soil_nitrogen_content"
        label="土壤含氮总量(g/100g)"
        width="auto"
        align="center"
      ></el-table-column>
      <el-table-column
        prop="total_soil_phosphorus_content"
        label="土壤含磷总量(g/100g)"
        width="auto"
        align="center"
      ></el-table-column>
...
function deleteSelectedRows () {
  ...
  ElMessageBox.confirm(
    ...
    .then(() => {
      ...
      deleteWetlandSoilId(requestObject)
        .then((res) => {
          if (res.response.value.code === 'SUCCESS') {
            getWaterLevelData()
            ElMessage({
