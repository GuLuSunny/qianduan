    ...
    <div class="form-container" v-if="current === 0">
      ...
      <div class="upload-container">
        ...
        <div class="download-template">
          <a href="/templates/气象数据模板.xlsx" download
            >点击此处下载Excel模板</a
          >
        </div>
      </div>
      ...
      ><!--
      <el-form-item label="观测地点：" :required="publishStatus === 'public'">
          <el-input
        ...
        <el-form-item label="观测类型：" :required="publishStatus === 'public'">
          <el-input
...
import { atmosphereInsertByExcel } from '@/api/getData'
...
function handleConfirm () {
  ...
  files.value.forEach((file) => {
    ...
    atmosphereInsertByExcel(formData)
      .then((res) => {
